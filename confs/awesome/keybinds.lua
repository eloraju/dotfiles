...
local scripts = require("shared").scripts
...
local globalkeys = {
  ...
  awful.key(M_Sft, "s", util.screenshot, { description = "run flameshot", group = "launcher" }),
  awful.key(M, "s", util.screenshotQuick, { description = "run flameshot", group = "launcher" }),
  ...
  awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -c 0 set Master 4%+") end),
  awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -c 0 set Master 4%-") end),
